sap.ui.define([
	...
	return BaseController.extend("com.owi.b2c.b2cWebRule.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("WebRules", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("WebRules", oData);
