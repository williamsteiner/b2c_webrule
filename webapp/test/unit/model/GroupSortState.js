sap.ui.define([
	"com/owi/b2c/b2cWebRule/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("RULENAME").length, 1, "The sorting by RULENAME returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by RULENAME and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("RULENAME");
