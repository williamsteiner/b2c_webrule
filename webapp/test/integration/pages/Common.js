sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/owi/b2c/b2cWebRule/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#WebRule-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#WebRule-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.owi.b2c.b2cWebRule.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/owi/b2c/b2cWebRule/localService/mockserver"], function (mockserver) {
