sap.ui.define([
	...
	return BaseObject.extend("com.owi.b2c.b2cWebRule.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias com.owi.b2c.b2cWebRule.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "RULENAME");
			}
